...
- Реализуйте класс `com.javawebinar.webapp.storage.com.javawebinar.basejava.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
- Протестируйте вашу реализацию с помощью классов `com.javawebinar.webapp.MainArray.main()` и `com.javawebinar.webapp.MainTestArrayStorage.main()`
