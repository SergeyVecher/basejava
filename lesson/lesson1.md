...
- Реализуйте класс `com.javawebinar.webapp.storage.com.javawebinar.basejava.webapp.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
- Протестируйте вашу реализацию с помощью классов `com.javawebinar.webapp.com.javawebinar.basejava.webapp.MainArray.main()` и `com.javawebinar.webapp.com.javawebinar.basejava.webapp.MainTestArrayStorage.main()`
