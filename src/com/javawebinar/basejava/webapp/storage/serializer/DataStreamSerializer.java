...
public class DataStreamSerializer implements StreamSerializer {
    ...
    @Override
    public void toWrite(Resume r, OutputStream os) throws IOException {
        try (DataOutputStream dos = new DataOutputStream(os)) {
            dos.writeUTF(r.getUuid());
            dos.writeUTF(r.getFullName());
            Map<ContactType, String> contacts = r.getContacts();
            writeCollection(dos, contacts.entrySet(), x -> {
                dos.writeUTF(x.getKey().name());
                dos.writeUTF(x.getValue());
            });

            writeCollection(dos, r.getSections().entrySet(), x -> {
                SectionType type = x.getKey();
                Section section = x.getValue();
